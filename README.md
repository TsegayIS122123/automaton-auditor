...
- 🔍 **Forensic Analysis**: Objectively verifying code artifacts
- ⚖️ **Nuanced Judgment**: Applying complex rubrics that require interpretation
- 📝 **Constructive Feedback**: Providing actionable remediation steps
...
- 🔗 [LangSmith Trace](https://smith.langchain.com/public/your-trace-link)
